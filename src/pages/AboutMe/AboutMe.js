            ...
            <Row className="pt-3 pb-5 align-items-center">
              <Col xs={12} md={3}>
                <Row className="justify-content-center mb-2 mr-2 ">
                  ...
                  <a class="btn btn-danger btn-lg m-1" href="https://drive.google.com/file/d/1VF4GcmpcTqQ6UXakt0WgbLibL3vuHE4C/view?usp=sharing" role="button" target="_blank">Download Resume</a>
                </Row>
              </Col>
              <Col xs={12} md={9}>
